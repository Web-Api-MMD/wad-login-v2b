// *** previously login.js --> account.js

const sql = require('mssql');
const config = require('config');
const Joi = require('joi');
const bcrypt = require('bcryptjs');
// const { result } = require('lodash'); <-- this line is an intellisense mistake, you might have seen similar before

const con = config.get('dbConfig_UCN');
const salt = parseInt(config.get('saltRounds'));

// previously class Login
class Account {
    ...
    // *** NEW static method validateResponse(accountResponse)
    ...
    // previously static readByEmail(loginObj)
            ...
            (async () => {
                ...
                try {
                    ...
                    const result = await pool.request()
                        // previously .input('userEmail', sql.NVarChar(255), loginObj.userEmail)
                    ...
                    // previously loginObj.userPassword
